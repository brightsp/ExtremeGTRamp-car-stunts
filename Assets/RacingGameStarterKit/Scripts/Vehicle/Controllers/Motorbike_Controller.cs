...
namespace RGSK
{
    public class Motorbike_Controller : MonoBehaviour
    {
        ...
        void LeanChassis()
        {
           ...
           //B  transform.eulerAngles = new Vector3(transform.eulerAngles.x, transform.eulerAngles.y, 0);
			...
			if (Physics.Raycast(transform.position,transform.up*-1,out hit,3)) 
				{
			...
			//Debug.Log ("Motor : " + motorInput + " Brake : " + brakeInput);
