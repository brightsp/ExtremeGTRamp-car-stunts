...
public class BikeControl : MonoBehaviour
{
	...
	public class ConnectWheel
	{
		...
		// connect to Front Right Wheel transform
		public Transform wheelBack;
		// connect to Front Left Wheel transform

		public Transform AxleFront;
		// connect to Back Right Wheel transform
		public Transform AxleBack;
		// connect to Back Left Wheel transform
	...
	public class BikeSetting
	{
		...
		// offset of centre of mass

		public float maxSteerAngle = 30.0f;
		// max angle of steering wheels
		public float maxTurn = 1.5f;

		public float shiftDownRPM = 1500.0f;
		// rpm script will shift gear down
		public float shiftUpRPM = 4000.0f;
		// rpm script will shift gear up
		public float idleRPM = 700.0f;
		// idle rpm

		public float stiffness = 1.0f;
		// for wheels, determines slip
...
//		#endif
	...
	void Update ()
	{
//		Debug.Log("---- Bike Controlls :::: "+activeControl);
		if (activeControl) {
